...
const profitParCategorie = useMemo(() => {
  ...
  return (
    {/* Header (extrait) */}
<div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-3 sm:flex-row flex-col sm:items-center">
